...
return null;}
function dtsrch(ts){window.location='http://www.namemesh.com/domain-name-search/'+ encodeURIComponent(ts);}
$(document).ready(function(){var gainter=setInterval(function(){try{if(!readCookie('GA_CLIENT_ID')){var clientid=ga.getAll()[0].get('clientId');setCookie('GA_CLIENT_ID',clientid,730);}else{clearInterval(gainter);}}catch(err){}},500);});$('#sbtn').click(function(e){value=document.getElementById('sinpt').value;if(value==""){window.location='/';}else{window.location='http://www.namemesh.com/domain-name-search/'+ encodeURIComponent(value)+'?show='+ show;}});if($("#dform").length>0){$("#dform").submit(function(event){$(this).attr('action','http://www.namemesh.com/company-name-generator/');});}
function formatResult(rterm){return'<div class="rterm">'+ rterm.id+'</div>';}
...
var name=domain.split(".")[0];var ext=domain.split(/\.(.+)?/)[1];_gaq.push(['_trackEvent','register',registrar,ext]);FDUPA.q.push(['conv',{'register':1,'registrar':registrar,'tld':ext}]);var head2,body2;var social='<p class="text-center" style="font-family:Arial;">Social Availability: <i class="icon-circle" style="color:green;"> Available &nbsp;&nbsp;&nbsp;</i> <i class="icon-circle" style="color:red;"> Unavailable </i></p>\
		<div style="font-family:Arial;" class="row soc col-md-10 col-md-offset-1 text-center" id="tc"><i class="icon-twitter-sign icon-large"></i>&nbsp;&nbsp;&nbsp;</div>\
		<div style="font-family:Arial;" class="row soc col-md-10 col-md-offset-1 text-center" id="fc"><i class="icon-facebook-sign icon-large"></i>&nbsp;&nbsp;&nbsp;</div><br><br><br>';var offers='<br><div class="row">\
...
+']);" href="/applycoupon/10854181">Web hosting for 1 penny for first month (use code: 1CENT) from <b>Hostgator</b>!</a></p>\
		</div>';var goffers='';if(registrar=='godaddy'){goffers='<div class="text-center" style="font-family:Arial;"><h4>Offers from GoDaddy</h4><hr>\
			<a onclick="_gaq.push(['+"'_trackEvent', 'code', 'gh'"+']);" target="_blank" href="/applycoupon/11391294">12 months Web Hosting + Free domain for <b>$1/mo</b></a><hr>\
			<a onclick="_gaq.push(['+"'_trackEvent', 'code', 'gwh'"+']);" target="_blank" href="/applycoupon/10378493"><b>$1/mo</b> Managed Wordpress Hosting + Free domain</a><hr>\
			<a onclick="_gaq.push(['+"'_trackEvent', 'code', 'gssl'"+']);" target="_blank" href="/applycoupon/11789166">25% off Standard SSL Certificates</a>\
			</div>'
goffers='<table class="table table-bordered">\
  <thead>\
    <tr><th>Offer</th>\
    <th>Promocode</th>\
    <th>Link</th>\
  ...
  <tbody>\
    <tr><td>$1/mo Web Hosting + Free Domain</td><td>CJC1HOS5</td><td><a href="/applycoupon/10386907" onclick="_gaq.push(['+"'_trackEvent', 'mcode', 'gh'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
    <tr><td>$1/mo Wordpress Hosting + Free Domain</td><td>CJCWPH1</td><td><a href="/applycoupon/10696523" onclick="_gaq.push(['+"'_trackEvent', 'mcode', 'wph'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
    <tr><td>30% off new purchases</td><td>CJC2OFF30</td><td><a href="/applycoupon/10789422" onclick="_gaq.push(['+"'_trackEvent', 'mcode', '30'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
    <tr><td>$3 .COM Domains + $1 Private Registration = $4.00</td><td>CJC3CP</td><td><a href="/register/godaddy/'+domain+'?cd=cjc3cp" onclick="_gaq.push(['+"'_trackEvent', 'mcode', '3cp'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
    <tr><td>$0.99 .Com Domains</td><td>CJC99COM</td><td><a href="/register/godaddy/'+domain+'?cd=cjc99com" onclick="_gaq.push(['+"'_trackEvent', 'mcode', '99'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
    <tr><td>25% off Standard SSL Certificates</td><td>CJC25SSL</td><td><a href="/applycoupon/11789166" onclick="_gaq.push(['+"'_trackEvent', 'mcode', 'ssl'"+']);" target="_blank"><button class="btn btn-primary">GO</button></a></td>\
  </tbody>\
</table>';goffers=window.gdoffers||'';goffers=goffers.replace(/{{domain}}/g,domain);}
var share='<div class="share row"><p class="text-center">Help us spread the word!</p>\
    	...
    	<div class="gp col-md-3 text-center">\
		<a href="https://plus.google.com/share?url=http%3A%2F%2Fwww.namemesh.com" target="_blank"><img\
...
+'"><img height=40 src="/media/101domain.png"></img><button class="btn btn-warning">101domain</button></a>\
			</div>';body2='<hr><a onclick="'+"_gaq.push([ '_trackEvent', 'code', 'bh']);"+'" href="/applycoupon/bluehost" target="_blank" style="text-decoration:none;display:block;" class="text-center"><img src="/static/bluehost.png"></img><h4> Get a <b>free domain</b> and 35% off on hosting from Bluehost!</h4></a>';body2=''}else{head2=' is not available <i class="icon-frown"></i>';body2='<div class="row reg text-center">'+'<a onclick="_gaq.push(['
+"'_trackEvent', 'nregister', 'sedo', '"+ ext+"'"
+']);" target="_blank" href="/register/sedo/'
+ domain
+'"><h3 class="text-center"> Click here to check on Sedo marketplace.</h3></a>'+'</div>';}
var div='<div class="modal fade" id="myModal" tabindex="-1" role="dialog"\
		aria-labelledby="myModalLabel" aria-hidden="true">\
    <div style="font-family: Arial;" class="modal-dialog">\
...
+ share+'\
  ...
  </div>';$(document.body).append(div);$('#myModal').modal('show');$.ajax({url:'http://www.twitter.com/'+ name,dataType:'jsonp',timeout:5000,statusCode:{0:function(){$("#tc").append('<span style="color:green;">&nbsp;'+ name
